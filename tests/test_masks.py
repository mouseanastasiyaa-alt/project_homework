...
def test_get_mask_card_number(card_numbers_raw: Dict[str, str], card_key: str, expected: str) -> None:
...
def test_get_mask_account(account_numbers_raw: Dict[str, str], acc_key: str, expected: str) -> None:
